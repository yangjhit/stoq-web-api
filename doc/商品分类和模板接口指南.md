...
| GET | `/product-categories/cluster/{clusterId}` | 获取集群的所有分类 |
...
| 字段 | 类型 | 必需 | 说明 |
|------|------|------|------|
| name | String | ✅ | 分类名称(2-200字符,集群内唯一) |
...
{
  "status": 409,
  "message": "Category name already exists in this cluster",
  "timestamp": "2025-11-16T18:09:35.079708"
}
```
...
curl -H "Authorization: Bearer YOUR_TOKEN_HERE" \
  http://localhost:8080/product-categories/cluster/1
```

**查询参数:**
- `clusterId` (路径参数,必需): 集群ID
